  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      <div className="container mx-auto py-12 px-4">
        <h1 className="text-5xl font-bold text-center mb-8 text-[#000040]">
          About Us
        </h1>

        <section className="mb-16">
          <h2 className="text-3xl font-semibold mb-4 text-[#000040]">
            Our Mission
          </h2>
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-semibold mb-6 text-[#000040]">
            Our Objectives
          </h2>
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              >
                <h3 className="text-xl font-semibold mb-2 text-[#000040] flex items-center">
                  <ChevronRight className="mr-2 text-[#cc4444]" />
                  {obj.title}
                </h3>
        ...
        <section className="mb-16 bg-gradient-to-r from-[#000040] to-[#000060] text-white rounded-lg shadow-xl p-8">
          <h2 className="text-3xl font-semibold mb-4">Our Impact</h2>
          <ul className="space-y-2 text-lg">
            <li className="flex items-center">
              <ChevronRight className="mr-2 text-[#cc4444]" /> Community Development Projects:
              Successfully completed numerous projects, impacting thousands of
              individuals.
            </li>
            <li className="flex items-center">
              <ChevronRight className="mr-2 text-[#cc4444]" /> Volunteer Hours: NSS volunteers
              have contributed millions of hours of service across various
              initiatives.
            </li>
            <li className="flex items-center">
              <ChevronRight className="mr-2 text-[#cc4444]" /> Nationwide Reach: With units
        ...
        <section className="mb-16 text-center">
          ...
          <Button title="Become a Volunteer" styles="bg-[#cc4444] hover:bg-[#b33c3c] text-white font-bold py-3 px-6 rounded-full text-lg shadow-lg hover:shadow-xl transition-all duration-300" color={""} />
        </section>

        {/* <section className="bg-white shadow-lg rounded-lg p-8">
          <h2 className="text-3xl font-semibold mb-4 text-[#000040]">Contact Us</h2>
          ...
          <ul className="text-lg text-gray-700 space-y-2">
            <li className="flex items-center"><ChevronRight className="mr-2 text-[#cc4444]" /> Email: info@nsswebsite.com</li>
            <li className="flex items-center"><ChevronRight className="mr-2 text-[#cc4444]" /> Phone: +91-XXXX-XXXXXX</li>
            <li className="flex items-center"><ChevronRight className="mr-2 text-[#cc4444]" /> Address: [University/Institution Address]</li>
          </ul>
        </section> */}
      </div>
    </div>
