...
import {
  ...
  saveAwardToFirebase,
  deleteAwardFromFirebase,
  fetchAwardsFromFirebase,
} from "@/api";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setAwards((prevAwards) =>
        currentAward.id
          ? prevAwards.map((a) => (a.id === currentAward.id ? currentAward : a))
          : [...prevAwards, { ...currentAward, id: awardId }]
      );
  ...
  const handleImageUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      uploadImageToFirebase(file)
        .then((imageUrl) =>
          setCurrentAward((prev) => ({ ...prev, image: imageUrl }))
        )
        .catch(console.error)
          ...
          >
            ...
            <div className="mt-4">
              ...
              <p className="mt-1 text-sm font-bold ">
                Date:{" "}
                <span className="text-gray-700 font-normal">{award.date}</span>
              </p>
            ...
            <div className="mt-4 flex font-medium justify-center space-x-4">
              <button
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="flex justify-end space-x-4">
                <button
                  type="button"
                  onClick={closeModal}
                  className="bg-[#FF5733] text-white font-bold py-2 px-4 rounded"
                >
                  Cancel
                </button>
                <button
